...
def prepare_urdf(input_path, output_urdf_path, output_xml_path):
    ...
    # We know the joint names from URDF
    joints = [
...
if __name__ == "__main__":
    prepare_urdf("assets/bittle_esp32.urdf", "assets/bittle_sim.urdf", "assets/bittle_final.xml")
